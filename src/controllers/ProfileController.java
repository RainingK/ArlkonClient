...
public class ProfileController implements Initializable {
    ...
    @FXML
    private Label username_label, email_label, date_label, balance_val_label;
    @FXML
    ...
    @FXML
    private TableView<List<String>> transaction_history;
    @FXML
    private TableView<List<String>> withdraw_transaction;
    ...
    private static String printData(int userId) {
        ...
        try {
            service = new webservices.ProfileWS_Service(new URL("http://" + getServerIp() + ":8080/ArlkonServer/ProfileWS?wsdl"));
        } catch (MalformedURLException ex) {
            Logger.getLogger(ProfileController.class.getName()).log(Level.SEVERE, null, ex);
        }
