...
public interface BinaryTransactionsWS {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getRisingType", targetNamespace = "http://webservices/", className = "webservices.GetRisingType")
    @ResponseWrapper(localName = "getRisingTypeResponse", targetNamespace = "http://webservices/", className = "webservices.GetRisingTypeResponse")
    @Action(input = "http://webservices/BinaryTransactionsWS/getRisingTypeRequest", output = "http://webservices/BinaryTransactionsWS/getRisingTypeResponse")
